...
public class CameraView extends SurfaceView implements SurfaceHolder.Callback, ICameraOperation, IActivityLifiCycle {
    public static final String TAG = "bob CameraView";
    ...
    public void setheight( int height ){
        ...
        mFocusAreaHeight = height;
    }

    public int getheight(){ return mFocusAreaHeight; }
...
//            toast("切换失败，请重试！", Toast.LENGTH_LONG);
    ...
    protected boolean onFocus(Point point, Camera.AutoFocusCallback callback) {
        ...
        if(Build.VERSION.SDK_INT >= 14) {
            ...
            int maxNum = parameters.getMaxNumFocusAreas();
            Log.d(TAG,"getMaxNumFocusAreas="+maxNum);
    ...
    private boolean focus(Camera.AutoFocusCallback callback) {
        try {
            ...
            Log.d(TAG,""+focusDistances[0]+","+focusDistances[1]+","+focusDistances[2]);
            String str = ""+focusDistances[0]+","+focusDistances[1]+","+focusDistances[2];
